            ...
            {!imagePreview && (!result || isDemo) && (
              <div className="mt-6 space-y-4">
                ...
                <button
                  ...
                  className="w-full sm:hidden flex items-center justify-center gap-3 px-6 py-4 bg-zinc-100 dark:bg-zinc-800 hover:bg-zinc-200 dark:hover:bg-zinc-700 text-zinc-700 dark:text-zinc-300 rounded-xl font-medium transition-colors border border-zinc-200 dark:border-zinc-700 active:scale-[0.98]"
                >
